...
int Tempo_Maximo_Espera_Antes_Feira_Parque=0;
...
void Interpreta_Mensagem()
{
	...
	int Hora_Entrada_Parque=Buffer[20];
	int Hora_Saida_Parque=Buffer[21];
...
Tempo_Espera_Filas_Bilheteiras_Antes_Entrar_Feira=Hora_Entrada_Parque-Hora_Entrada_Filas_Bilheteiras;
...
//Tratamento dos Tempos Maximos:
Tempo_Espera_Fila_C_Antes_Desistir=Hora_Desistencia_Fila_Carroussel-Hora_Entrada_Fila_Carroussel;
...
else if(Tempo_Espera_Fila_C_Antes_Desistir>Tempo_Maximo_Espera_Antes_Desistir_Fila_Carroussel)
{
	Tempo_Maximo_Espera_Antes_Desistir_Fila_Carroussel=Tempo_Espera_Fila_Carroussel_Antes_Desistir;
}
...
Mostra_Zonas_Tempo_Real(50, 100, 500, Total_Clientes_Acutalmente_No_Bar, Total_Clientes_Acutalmente_No_Carroussel, Total_Clientes_Acutalmente_Na_Feira);
...
system("clear");
printf("        ┌──────────────────────────────────────────────────────────────┐\n");
printf("        │   Sistemas Operativos 2016/2017 ─ Simulacao Parque Aquatico  │\n");
printf("        └──────────────────────────────────────────────────────────────┘\n");
printf("┌──────────────────────────────────────┌────────────────────────────────────────────────────────────┐\n");
