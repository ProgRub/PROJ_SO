...
{
	int Tempo_Estadia=rand() %500 + 300; //Cria Numero Random de 300 a 500. Preciso Ver Quanto É Que Isto Corresponde em Horas
...
cliente[ID_Cliente].Tempo_Estadia_Parque=Define_Tempo_Estadia_Cliente_No_Parque();
...
cliente[ID_Cliente].Lugar_Fila_MontanahRussaG=0;
cliente[ID_Cliente].Lugar_Fila_MontanahRussap=0;
